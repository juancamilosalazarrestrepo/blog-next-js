...
export default function BlogTemplate() {
  return (
    <Layout>
      <SEO title="Calculadora en React Native | Portafolio" description="Calculadora desarrollada en React Native con diseño moderno y modo oscuro. Proyecto de aplicación móvil multiplataforma." />
      <Calculadora />
    </Layout>
  );
}
