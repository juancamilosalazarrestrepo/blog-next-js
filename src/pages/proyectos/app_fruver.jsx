...
const AppFruver = () => {
    return (
        <Layout>
            <SEO
                title="App Fruver | Control de Inventario, Ventas y Ganancias para Android"
                description="Aplicación Android para fruvers y verdulerías. Gestión de inventario, registro de ventas y seguimiento de ganancias en tiempo real desde el celular."
                ...
                imageAlt="App Fruver - Control de inventario y ventas para Android"
                type="website"
                    ...
                    <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
                        ...
                        <div className="w-full lg:flex-1 max-w-2xl lg:max-w-none text-center lg:text-left z-20">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.05] tracking-tight">
                                App <span className="text-[#bbf7d0]">Fruver</span>
                            </h1>
                            <p className="text-lg md:text-xl lg:text-2xl opacity-90 mb-10 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0">
                                Aplicación Android para llevar el control total de tu frutería y verdulería: inventario en tiempo real, registro de ventas y seguimiento de ganancias, todo desde tu celular.
                            </p>
                            ...
                            <div className="animate-[float_5s_ease-in-out_infinite] drop-shadow-2xl flex gap-4 lg:gap-6 items-end">
                                ...
                                <div className="w-36 md:w-44 bg-white/10 backdrop-blur-md border border-white/20 rounded-[2rem] p-3 shadow-2xl">
                                    <div className="bg-[#14532d] rounded-[1.5rem] overflow-hidden h-64 md:h-80 flex flex-col">
                                        <div className="bg-[#166534] px-4 py-3 flex items-center justify-between">
                                            <span className="text-white text-xs font-bold">📦 Inventario</span>
                                ...
                                <div className="w-36 md:w-44 bg-white/10 backdrop-blur-md border border-white/20 rounded-[2rem] p-3 shadow-2xl mb-8">
                                    <div className="bg-[#14532d] rounded-[1.5rem] overflow-hidden h-72 md:h-96 flex flex-col">
                                        <div className="bg-[#166534] px-4 py-3 flex items-center justify-between">
                                            <span className="text-white text-xs font-bold">💰 Ganancias</span>
                                            <span className="text-green-300 text-xs">Hoy</span>
                                        </div>
                                        <div className="flex-1 p-3 flex flex-col gap-3">
                                            <div className="bg-white/10 rounded-2xl p-3 text-center">
                                                <p className="text-green-300 text-[10px] font-bold uppercase tracking-wide mb-1">Total del Día</p>
                                                <p className="text-white text-xl font-black">$184.500</p>
                                            </div>
                                            <div className="grid grid-cols-2 gap-2">
                                                <div className="bg-white/10 rounded-xl p-2 text-center">
                                                    <p className="text-green-300 text-[9px] font-bold">Ventas</p>
                                                    <p className="text-white text-sm font-black">37</p>
                                                </div>
                                                <div className="bg-white/10 rounded-xl p-2 text-center">
                                                    <p className="text-green-300 text-[9px] font-bold">Ganancia</p>
                                            ...
                                            <p className="text-white/40 text-[9px] text-center">Últimos 7 días</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="w-36 md:w-44 bg-white/10 backdrop-blur-md border border-white/20 rounded-[2rem] p-3 shadow-2xl">
                                    <div className="bg-[#14532d] rounded-[1.5rem] overflow-hidden h-64 md:h-80 flex flex-col">
                                        <div className="bg-[#166534] px-4 py-3 flex items-center justify-between">
                                            <span className="text-white text-xs font-bold">🛒 Ventas</span>
                ...
                <section className="px-6 py-20 bg-white dark:bg-slate-900">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col gap-4 mb-16 text-center max-w-2xl mx-auto">
                            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">¿Qué hace la app?</h2>
                            <p className="text-slate-500 dark:text-slate-400 text-lg">Todo lo que el dueño de un fruver necesita, en la palma de la mano.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-5 p-8 rounded-3xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-lg transition-shadow">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Control de Inventario</h3>
                                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">Registra cada producto con nombre, cantidad, unidad (kg, unidad, libra) y precio de compra. El stock se actualiza automáticamente con cada venta.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-5 p-8 rounded-3xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-lg transition-shadow">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Registro de Ventas</h3>
                                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">Registra cada venta en segundos: selecciona el producto, la cantidad y el precio de venta. Historial completo con hora y fecha de cada transacción.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-5 p-8 rounded-3xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-lg transition-shadow">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Seguimiento de Ganancias</h3>
                                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">Dashboard con ganancias del día, la semana y el mes. Calcula automáticamente la diferencia entre precio de compra y precio de venta.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-20">
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                                <div className="flex-1 text-center md:text-left">
                                    <span className="inline-block bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full mb-4">Inventario</span>
                                    <h3 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Stock siempre al día</h3>
                                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-6">Agrega productos con su cantidad disponible, unidad de medida y precio de compra. La app descuenta automáticamente del stock cada vez que registras una venta, así siempre sabes cuánto te queda.</p>
                                    <ul className="flex flex-col gap-3">
                                        {["Alta y edición de productos en segundos", "Unidades: kg, libra, arroba, unidad", "Alertas visuales cuando el stock es bajo", "Historial de entradas de mercancía"].map(item => (
                            ...
                            <div className="flex flex-col md:flex-row-reverse items-center gap-10 md:gap-16">
                                <div className="flex-1 text-center md:text-left">
                                    <span className="inline-block bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full mb-4">Ventas</span>
                                    <h3 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Registra cada venta en segundos</h3>
                                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-6">Con solo seleccionar el producto y la cantidad, la app calcula el total y lo guarda con fecha y hora. Al final del día tienes un resumen claro de todo lo que vendiste.</p>
                                    <ul className="flex flex-col gap-3">
                                        {["Registro rápido desde pantalla principal", "Cálculo automático de totales", "Historial de ventas por día / semana / mes", "Edición y eliminación de registros"].map(item => (
                                            <li key={item} className="flex items-center gap-3 text-slate-700 dark:text-slate-300">
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                                <div className="flex-1 text-center md:text-left">
                                    <span className="inline-block bg-lime-100 dark:bg-lime-900/30 text-lime-700 dark:text-lime-400 text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full mb-4">Ganancias</span>
                                    <h3 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Sabe exactamente cuánto ganás</h3>
                                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-6">La app calcula automáticamente la diferencia entre lo que pagaste por la mercancía y lo que cobraste al venderla. Sin hojas de cálculo, sin calculadora, sin confusiones.</p>
                                    <ul className="flex flex-col gap-3">
                                        {["Ganancia neta por producto y por período", "Gráfica de ventas de los últimos 7 días", "Resumen diario, semanal y mensual", "Comparativa entre períodos"].map(item => (
                                            <li key={item} className="flex items-center gap-3 text-slate-700 dark:text-slate-300">
                                    ...
                                    <div className="w-52 bg-[#14532d] rounded-[2rem] p-4 shadow-2xl">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="bg-green-500/30 border border-green-500/40 rounded-xl p-3 text-center">
                                                <p className="text-green-300 text-[10px] font-bold uppercase tracking-wide">Ganancia Neta</p>
                                                <p className="text-white text-2xl font-black">$52.000</p>
                                            </div>
                                            <div className="grid grid-cols-2 gap-2">
                                                <div className="bg-white/10 rounded-xl p-2 text-center">
                                                    <p className="text-white/60 text-[9px]">Ventas</p>
                                                    <p className="text-white font-black">$184k</p>
                                                </div>
                                                <div className="bg-white/10 rounded-xl p-2 text-center">
                                                    <p className="text-white/60 text-[9px]">Costo</p>
                                                    <p className="text-white font-black">$132k</p>
                                                </div>
                                            </div>
                                            {/* Bar chart */}
                                            <div className="bg-white/5 rounded-xl p-2">
                                                <p className="text-white/40 text-[9px] mb-2">Últimos 7 días</p>
                ...
                <section className="px-6 py-20 bg-white dark:bg-slate-900">
                    <div className="max-w-5xl mx-auto">
                        <div className="flex items-center gap-4 mb-12 justify-center">
                            ...
                            <span className="text-sm font-black text-slate-400 uppercase tracking-[0.2em]">Stack Tecnológico</span>
                            <span className="h-px w-16 bg-slate-300 dark:bg-slate-700"></span>
                        </div>
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-[2.5rem] overflow-hidden border border-slate-100 dark:border-slate-800 shadow-xl">
                            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-100 dark:divide-slate-800">
                                <div className="p-10 flex flex-col gap-6">
                                    <h3 className="text-xl font-black text-slate-900 dark:text-white">Frontend / App</h3>
                                ...
                                <div className="p-10 flex flex-col gap-6">
                                    <h3 className="text-xl font-black text-slate-900 dark:text-white">Datos & Almacenamiento</h3>
                                    <div className="flex flex-col gap-4">
                                        {[
                ...
                <section className="px-6 py-24 text-center bg-slate-50 dark:bg-slate-800/30">
                    <div className="max-w-3xl mx-auto flex flex-col items-center">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 mb-10 text-xl md:max-w-xl mx-auto">
                            Desarrollo aplicaciones móviles Android a medida para negocios pequeños y medianos. Simples, rápidas y sin complicaciones.
                        </p>
