            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
                <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-24">
                    <div className="w-full lg:w-1/2 space-y-6">
                        <span className="inline-block px-4 py-1.5 bg-[#1152d4]/10 text-[#1152d4] dark:bg-[#1152d4]/20 dark:text-blue-300 text-xs font-bold uppercase tracking-widest rounded-full">{t('webDevSection.badge')}</span>
